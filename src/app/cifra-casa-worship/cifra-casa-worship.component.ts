...
@Component({
  selector: 'app-cifra-casa-worship',
  templateUrl: './cifra-casa-worship.component.html',
  styleUrls: ['./cifra-casa-worship.component.css']
})
export class CifraCasaWorshipComponent implements OnInit {
  ...
  constructor( private crudService: CrudService,
    ...
    this.crudService.casaWorship().subscribe((data:any[]) => {
