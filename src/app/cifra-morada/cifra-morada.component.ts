...
@Component({
  selector: 'app-cifra-morada',
  templateUrl: './cifra-morada.component.html',
  styleUrls: ['./cifra-morada.component.css']
})
export class CifraMoradaComponent implements OnInit {
  ...
  constructor( private crudService: CrudService,
    ...
    this.crudService.getMorada().subscribe((data:any[]) => {
