...
@Component({
  selector: 'app-cifra-zoe',
  templateUrl: './cifra-zoe.component.html',
  styleUrls: ['./cifra-zoe.component.css']
})
export class CifraZoeComponent implements OnInit {
  ...
  ngOnInit() {
        ...
        this.crudService.getZoe().subscribe((data:any[]) => {
