...
@Component({
  selector: 'app-cifra-isaias-saad',
  templateUrl: './cifra-isaias-saad.component.html',
  styleUrls: ['./cifra-isaias-saad.component.css']
})
export class CifraIsaiasSaadComponent implements OnInit {
  ...
  ngOnInit() {
        ...
        this.crudService.isaiasSaad().subscribe((data:any[]) => {
